...
#$ -N vibrant2propagate
#$ -V
#$ -o /workdir/users/acv46/stool_PROSeq3/log/vibrant2propagate_$JOB_ID.out
#$ -e /workdir/users/acv46/stool_PROSeq3/log/vibrant2propagate_$JOB_ID.err
